...
class Controlador
{
    ...
    {
        $con = new Conexion();
        $sql = "SELECT id, pregunta, respuesta, activo FROM parcela;";
    ...
    public function postNuevo($_nuevoObjeto)
    {
        ...
        $sql = "INSERT INTO parcela (id, pregunta, respuesta, activo) VALUES ($id,'$_nuevoObjeto->pregunta', '$_nuevoObjeto->respuesta', true)";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
    ...
    {
        $con = new Conexion();
        $sql = "UPDATE parcela SET pregunta = '$_nuevo' WHERE id = $_id;";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
    ...
    {
        $con = new Conexion();
        $sql = "UPDATE parcela SET respuesta = '$_nuevo' WHERE id = $_id;";
        // echo $sql;
        //ejecutar sql
        $rs = [];
        try {
