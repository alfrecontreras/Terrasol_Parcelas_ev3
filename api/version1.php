...
$_token_get_evaluacion = 'Bearer get_Terrasol';
$_token_post = 'Bearer get_Terrasol';
$_token_put = 'Bearer get_Terrasol';
$_token_patch = 'Bearer get_Terrasol';
$_token_delete = 'Bearer get_Terrasol';